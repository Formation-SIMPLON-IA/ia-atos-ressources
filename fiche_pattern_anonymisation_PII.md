...
de texte, voir [`fiche_pattern_texte_NLP.md`](./fiche_pattern_texte_NLP.md) ;
pour le stockage du texte (vectoriel/RAG), [`grille_decision_stockage.md`](./grille_decision_stockage.md).*