...
|---|---|---|---|---|---|---|
| 1 | **Cadrer** — besoin métier, tâche ML, risques éthiques identifiés dès le départ | §0-§1 | Cadrage écrit, dictionnaire des risques, setup traçabilité (versions, hash, git) | `fiche_choix_famille_ML.pdf` · `fiche_cycle_vie_donnee.md` · `fiches_revision_C1_C2_C4.md` (C1, C2) | M3, M8 | ✅ faisable |
